...
trayer --edge bottom --align right --SetDockType true --SetPartialStrut false --expand true --width 5 --height 17 --transparent true --tint 0x0 --distance -1063 --distancefrom bottom --monitor primary &
